...
- Fazer o download do .zip a partir do [GitHub](https://github.com/TCM-TW02/trabalhofinal/archive/main.zip);
...
- No Visual Studio Code, ir a File > Open Folder e abrir a folder "src".
- Abrir ficheiro "TW02_html.html" e clicar em "Go Live";
- Disfrutar do website.

### 3.2 Regras de Utilização

- Apenas pode ser acedido a partir do computador (Firefox recomendado) com a resolução recomendada de 1920x1080 e mobile, nomeadamente iPhone 6/7/8 iOS 11 pois o website com criado com estas duas medidas em mente.
